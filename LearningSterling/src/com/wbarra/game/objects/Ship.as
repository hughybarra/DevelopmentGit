...
//			var shipImage:Image = Image.fromBitmap(new AllMyImages.SHIP());
			x = Math.random()*480;
			y = -10 + (Math.random()*-50);
//			shipImage.scaleX = shipImage.scaleY = .3;
//			addChild(shipImage);
			
			__enemyEquation = new TextField(100, 50, "1 + 1:");
//			__enemyEquation.border = true;
		...
		public function shipMove():void
		{
			...
			// this updates the position of x for the bullet to track 
			__newX = x;
			__newY = y;
		}
