package com.wbarra.screens
{
	...
	import com.wbarra.utilityBuilder.ScreenSlider;
	...
	public class GameStart extends Sprite
	{
		...
		private function runStart():void
		{
			...
			var gameTitle:TextField = new TextField(400, 100, "MATH DEFENCE", "alpha", 40);
			gameTitle.x = 50;
			gameTitle.y = 300;
...
//				removeEventListener(Event.ENTER_FRAME, onEnterFrame); // why is this breaking? I dont get it 
